...
- `skills/**/examples/**` — the example draftbooks, storyboards, and their scene
  artifacts (`.svg`, `.png`, `.yobj`, `.html`).
- `skills/**/assets/**` — theme and illustration assets.
...
This file is the human-readable summary and the authoritative SPDX declaration.
